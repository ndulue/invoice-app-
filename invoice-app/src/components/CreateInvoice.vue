                    ...
                    <div class="col-md-12">
                        ...
                        <form action="" @submit.prevent="onSubmit">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="eg Seller's Invoice" v-model="invoice.name">
                            </div>

                            <div class="form-group">
                                <label for="">Invoice Name:</label><span> ${{ invoice.total_price }}</span>
                            </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <template v-for="txn in transaction">
                                        <tr :key="txn.id">
                                            <th>{{ txn.id }}</th>
                                            <td>{{ txn.name }}</td>
                                            <td>{{ txn.price }}</td>
                                            <td><button type="button" class="btn btn-danger" v-on:click="deleteTransaction(txn.id)"></button></td>
                                        </tr>
                                    </template>
                                </tbody>
                            </table>
